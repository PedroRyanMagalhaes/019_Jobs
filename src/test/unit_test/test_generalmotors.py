"""
Teste unitário para o scraper da General Motors
"""
import sys
...
def test_scraper():
    """Testa o scraper da General Motors"""
    ...
    print(f"--- TESTANDO SCRAPER DA GENERAL MOTORS ---")
    ...
    # Executa o scraper
    vagas_coletadas = Generalmotors.raspar()

    # Verifica o resultado
    if vagas_coletadas:
        print(f"\n✅ SUCESSO! {len(vagas_coletadas)} vagas da General Motors encontradas.")
        ...
        print("\n⚠️ AVISO: Nenhuma vaga de Sorocaba ou Remota encontrada no momento.")
