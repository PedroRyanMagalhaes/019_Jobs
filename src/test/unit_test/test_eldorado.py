"""
Teste unitário para o scraper do Instituto Eldorado
"""
import sys
...
def test_scraper():
    ...
    print(f"--- TESTANDO SCRAPER DO ELDORADO ---")
    ...
    assert vagas_coletadas, "❌ Nenhuma vaga do Eldorado foi encontrada no teste."
    assert len(vagas_coletadas) > 0, "Lista de vagas está vazia"
    
    print(f"\n✅ SUCESSO! {len(vagas_coletadas)} vagas do Eldorado encontradas.")
